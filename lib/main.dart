...
import 'package:bookly/features/home/presentation/view_models/cubit/newset_books_cubit_cubit.dart';
      ...
      providers: [
        BlocProvider(
          create: (ctx) => FeaturedBooksCubit(
            ...
            //.. speed operator => alternative to StfullWidget inside HomeView
          )..fetchFeaturedBooks(),
        ),
        BlocProvider(
          create: (ctx) => NewsetBooksCubit(
            getIt.get<HomeRepoImplementaion>(),
          )..fetchNewsetBook(),
        ),
      ],
